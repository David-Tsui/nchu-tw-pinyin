...
return array(
    ...
    */
    ...
    "active_url"       => ":attribute 必須是有效的URL地址",
    "after"            => ":attribute 必須是在 :date 之後的日期",
    "alpha"            => ":attribute 只能包含英文字母",
    "alpha_dash"       => ":attribute 只能包含英文字母,數字和負號",
    ...
    "regex"            => ":attribute 無效",
    "required"         => ":attribute 必須輸入",
    "required_if"      => ":other 為 :value 的時候必須輸入 :attribute",
    //"required_with"    => ":values 填寫了的時候也必須填寫 :attribute",
    "required_with"    => ":values 及 :attribute 都必須輸入",
    "required_without" => ":values 不輸入的時候必須輸入 :attribute",
