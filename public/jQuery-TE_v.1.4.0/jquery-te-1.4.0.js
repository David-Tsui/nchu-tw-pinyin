...
(function($){		
	$.fn.jqte = function(options){
		...
		var varsTitle = [
			...
			{title:"新增有序序列",hotkey:"."},
			{title:"新增無序序列",hotkey:","},
			{title:"設為下標",hotkey:"down arrow"},
			{title:"設為上標",hotkey:"up arrow"},
			{title:"減少縮排",hotkey:"left arrow"},
			{title:"增加縮排",hotkey:"right arrow"},
			{title:"文字靠左"},
			{title:"文字置中"},
			{title:"文字靠右"},
			{title:"加上橫線",hotkey:"K"},
			{title:"嵌入連結",hotkey:"L"},
			{title:"移除連結"},
			{title:"清除所有樣式",hotkey:"Delete"},
			{title:"新增水平分隔線",hotkey:"H"},
			{title:"Html編輯器"}
			];
